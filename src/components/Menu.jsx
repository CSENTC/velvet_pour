...
const Menu = () => {
    ...
    useGSAP(() => {
        gsap.fromTo(
            '#title', { opacity: 0}, {opacity: 1, duration: 1}
        );
    ...
    <section id="menu" aria-labelledby="menu-heading">
        ...
        <div className="content">
            <div className="arrows">
                <button className="hex-left" onClick={() => goToSlide(currentIndex - 1)}>
                    <span>{prevCocktail.name}</span>
                    <img src="/images/right-arrow.png" alt="right-arrow" />
                </button>
                <button className="hex-right" onClick={() => goToSlide(currentIndex + 1)}>
